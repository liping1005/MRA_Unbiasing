...
if((true_noise_sigma == 0.5) && strcmp(RandomDilationOpts.DilationCalc, 'Empirical'))
    myStr = sprintf('results_f%d_l%d_sigma_half_learn_eta_sigma_half.mat', Signal, l);
elseif(true_noise_sigma == 1.0 && strcmp(RandomDilationOpts.DilationCalc, 'Empirical'))
    myStr = sprintf('results_f%d_l%d_learn_eta.mat', Signal, l);
end

if((true_noise_sigma == 0.5) && strcmp(RandomDilationOpts.DilationCalc, 'Oracle'))
    myStr = sprintf('results_f%d_l%d_oracle_sigma_half.mat', Signal, l);
elseif(true_noise_sigma == 1.0 && strcmp(RandomDilationOpts.DilationCalc, 'Oracle'))
    myStr = sprintf('results_f%d_l%d_oracle.mat', Signal, l);
end
