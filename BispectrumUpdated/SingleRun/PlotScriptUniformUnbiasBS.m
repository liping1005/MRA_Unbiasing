...
myStr = sprintf('/mnt/ufs18/home-109/yinlipi1/bispectrum/NumericalExperiments/Empirical/results_f%d_l%d_oracle.mat', Signal, l);
load(myStr)
errorbar(log2(Mvalues(plot_idx)), log2(BSerrorVec_NoDilUnbias(plot_idx)),SDLogBSerrorVec_NoDilUnbias(plot_idx)/sqrt(NumberSimulationsPerValue),'-','Linewidth',2)
...
hold off
save_name = sprintf('f%d_oracle_bs_recovery.pdf', Signal);
